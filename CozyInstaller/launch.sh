...
replace_app_icons() {
    bg_ongoing="./bg/bg_icon.png"
    apps_folder="/mnt/SDCARD/Apps"
    source_folder="./ThemeFiles/Apps"

    /mnt/SDCARD/System/usr/trimui/scripts/infoscreen.sh -i ${bg_ongoing}
    for icon_path in "BootLogo/icon.png" "EbookReader/icon.png" "EmuCleaner/EmulatorsCleaner.png" "FileManager/commander.png" "MusicPlayer/icon.png" "OTA-update/icon.png" "PortMaster/icon.png" "random/icon.png" "Reboot/icon.png" "RetroArch/retroarch.png" "Scraper/Scraper.png" "SystemTools/icon.png" "Terminal/icon.png" "user_guide/icon.png" "ScreenRecorder/icon/icon.png"; do
...
replace_app_icons_system() {
    bg_ongoing="./bg/bg_icon_system.png"
    source_folder="./ThemeFiles"

    /mnt/SDCARD/System/usr/trimui/scripts/infoscreen.sh -i ${bg_ongoing}
    for icon_path in "/usr/trimui/apps/fn_editor/icon.png" "/usr/trimui/apps/usb_storage/usb_icon.png" "/usr/trimui/apps/moonlight/ic-moonlight.png" "/usr/trimui/apps/player/ic-media-player.png"; do
        if [ -f "${icon_path}" ]; then
...
main() {
    bg="./bg/instruction.png"
    bg_exit="./bg/bg_exit.png"
